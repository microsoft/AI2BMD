    ...
    def simulate(
        ...
        if (not restart) and (self.preeq_steps != 0):
            ...
            for restraint in restraints:
                ...
                for idx in indices_to_constrain:
                    ...
                    constraint = Hookean(
                        a1=idx, a2=pos, k=restraint * kcalmol2ev, rt=0
                    )
        ...
        if hydrogen_constraints is True:
            ...
            for pair in hydrogen_bonds:
                # * fix constraints
                # hydrogen_constraints.append([pair[0], pair[1]])
                # hydrogen_lengths.append(pair[2])
                # hydrogen_constraint = FixBondLengths(
                #     [pair[0], pair[1]], bondlengths=[pair[2]]
                # )
            ...
            # self.prot.set_constraint(FixBondLengths(hydrogen_constraints, bondlengths=hydrogen_lengths))
